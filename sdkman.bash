...
# install:- channel: beta; cliVersion: latest+67de99c; cliNativeVersion: 0.4.6; api: https://beta.sdkman.io/2
...
# Global variables
export SDKMAN_SERVICE="https://beta.sdkman.io/2"
export SDKMAN_VERSION="latest+67de99c"
